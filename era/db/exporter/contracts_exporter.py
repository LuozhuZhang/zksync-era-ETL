      ...
      for row in reader:
        cur.execute(f"""
          INSERT INTO {full_table_name} (
            type, contract_address, transaction_hash, block_time,
            block_number, block_hash, from_address, to_address
...
def export_contracts():
  ...
  csv_base_folder = os.path.join(current_file_path, '..', '..', '..', 'data', 'json_to_csv', 'era', 'all_contracts')
  parallel_import(db_config, csv_base_folder, 'era', 'contracts', 'all_contracts', END_BLOCK, import_csv_to_db)
