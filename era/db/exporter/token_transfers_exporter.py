      ...
      for row in reader:
        cur.execute(f"""
          INSERT INTO {full_table_name} (
            type, transaction_hash, block_number, block_time, 
...
def export_token_transfers():
  ...
  csv_base_folder = os.path.join(current_file_path, '..', '..', '..', 'data', 'json_to_csv', 'era', 'all_token_transfers')
  parallel_import(db_config, csv_base_folder, 'era', 'token_transfers', 'all_token_transfers', END_BLOCK, import_csv_to_db)
